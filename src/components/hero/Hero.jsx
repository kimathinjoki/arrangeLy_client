            ...
            <header className="bg-gray-900 pattern">
                <div className="container px-6 mx-auto">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <p className="mt-4 text-2xl font-bold text-gray-200 text-with-shadow">Sit Back and Let Science Seat Your Guests. Blend family dynamics, friendships, and social preferences into a seating chart everyone will love.</p>
                    </div>
                ...
                <style jsx>{`
                    .pattern {
                        background-image: url("https://images.pexels.com/photos/949587/pexels-photo-949587.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2");
